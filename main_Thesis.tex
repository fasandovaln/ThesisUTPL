% ====================================================================
%%- Archivo de ejemplo para la clase ThesisUTPL -%%
% ====================================================================
...
%
% 2. Estilo de Bibliografía
%   Opciones posibles: ``APA'', ``IEEE''
%   Valor por defecto: ``APA''
%	Nota: Por favor revise las consideraciones en la compilación, dadas 
% 	      en el documento de ejemplo, para el cambio entre opciones
%
% 3. Hiperenlaces: 
...
%
% Class: ThesisUTPL
\documentclass[unAutor, APA, hiperenlaces]{ThesisUTPL}
%
% Preámbulo:
...
\area{Técnica}													% Área: Técnica, Administrativa, etc
\ciudad{Loja}													% Ciudad de publicación de la tesis
\pais{Ecuador}													% País de publicación de la tesis
\mes{noviembre}													% mes de publicación de la tesis
\ano{2018}														% año de publicación de la tesis
%
%
% ====================================================================
...
\begin{document}
	%
%%- Pre-Capítulos -%% ------------------------------------------------
% 		Corresponde a todas las páginas iniciales como: Carátula, Aprobación del director, 
...
\chapter{ANEXOS}
%
\input{DOCUMENTS/6_ANEXO_1}


%%- Página: Bibliografía -%% -----------------------------------------
\paginaBibliografia{
	% Archivo de biliografia
	\bibliography{BibliographyUTPL}
}
